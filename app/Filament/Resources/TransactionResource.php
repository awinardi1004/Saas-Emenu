...
class TransactionResource extends Resource
{
        ...
        return $form
            ->schema([
                ...
                Forms\Components\TextInput::make('table_number')
                    ->label('Nomor Meja')
                    ->required(),
                Forms\Components\Select::make('payment_mathod')
                    ->label('Metode Pembayara')
                    ->options([
                        'cash' => 'Tunai',
                        'midtrans' => 'Midtrans'
                    ])
    ...
    {
        $selectProducts = collect($get('transactionDetails'))->filter(fn($item) => !empty($item['product_id']) && !empty($item['quantity']));
